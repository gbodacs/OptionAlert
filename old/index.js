...
For an over simplified version, if the filter is too complicated to take indicators into effect, you could just report on any 1 min chart with Volume over 1,000, then we could manually filter from there.

This is 1 Strategy.  I call it my Scalping Strategy.  I envision an app where a user could select a Strategy from a drop down list and have the app / script give the results of the scan.
*/